      ...
      <View style={styles.launchImageContainer}>
        <View style={styles.firstImageContainer}>
          <Image
            ...
            source={require('./../../assets/images/images/dinner.jpg')}
          />
        </View>
        <View style={styles.secondImageContainer}>
          <Image
            style={styles.secondImage}
            source={require('./../../assets/images/images/dinner2.jpg')}
          />
          <TouchableOpacity style={{height: '48%'}}>
            ...
            <Image
              ...
              source={require('./../../assets/images/images/dinner3.jpg')}
            />
          </TouchableOpacity>
        </View>
      </View>
